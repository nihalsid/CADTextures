...
int main(int argc, char* argv[]) {
  ...
  Vec3f max_box(-std::numeric_limits<float>::max(), -std::numeric_limits<float>::max(),
              -std::numeric_limits<float>::max());
  ...
  // std::cout << "min_all_dim" << min_all_dim << "max_all_dim" << max_all_dim << std::endl;
  min_box[0] = min_all_dim;
  min_box[1] = min_all_dim;
  min_box[2] = min_all_dim;
  max_box[0] = max_all_dim;
  max_box[1] = max_all_dim;
  max_box[2] = max_all_dim;
