...
class TextureRegressionModule(pl.LightningModule):
    ...
    def forward(self, batch):
        ...
        # refinement = TextureMapDataset.apply_mask_texture(batch['partial_texture'], 1 - batch['mask_missing']) \
        #              + TextureMapDataset.apply_mask_texture(refinement, batch['mask_missing'])
    ...
    def validation_epoch_end(self, outputs):
        ...
        with torch.no_grad():
            ...
            for batch_idx, batch in enumerate(loader):
                ...
                # nihalsid: dump results for metrics
                # target_batch = batch['texture'].cpu().numpy()
